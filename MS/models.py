...
class mobile_ms_server(models.Model):
    ...
    room_name       = models.CharField(max_length=32, verbose_name = u"room_name")
    server_version  = models.CharField(max_length=32, verbose_name = u"server_version")
    protocol_version= models.CharField(max_length=32, verbose_name = u"protocol_version")        
    identity_file   = models.CharField(max_length=32, verbose_name = u"protocol_version")
    password        = models.CharField(max_length=32, verbose_name = u"password")    
    # status 
