...
class mobile_room(models.Model):
    ...
    num_dispatching= models.IntegerField(blank = False, null = True,  verbose_name = u"change_num") 
    num_deleting  = models.IntegerField(blank = False, null = True,  verbose_name = u"change_num")    
    operation_time= models.DateTimeField(auto_now_add=True, verbose_name = u"check_time")
